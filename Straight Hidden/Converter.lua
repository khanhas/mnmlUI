...
function ConvertFile()
	...
	meterOptions = meterOptions .. "[!SetOption Shape Shape"..(countshape+3).." \"Rectangle (110*#scale#),0,(-110*#scale#),(250*#scale#) | StrokeWidth 0 | Fill Color #Color#\"]"
	...
	meterOptions = meterOptions .. "[!SetOption Shape Shape"..(countshape+5).." \"Rectangle (110*#scale#),(30*#scale#),(-2*#scale#),(210*#scale#) | StrokeWidth 0 | Fill Color #Color#\"]"
