function replacetext()
  ...
  text= string.lower(SKIN:GetMeasure('MeasureDay'):GetStringValue())
  ...
  SKIN:Bang('[!Commandmeasure ScriptVectorConverter "ClearAllShapePath2()"][!CommandMeasure Inkscape2 "Run"]')
