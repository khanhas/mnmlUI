...
function ConvertFile()
	...
	meterOptions = meterOptions .. "[!SetOption Shape Shape"..(countshape+3).." \"Rectangle (45*#scale#),(180*#scale#),(230*#scale#),(-40*#scale#) | StrokeWidth 0 | Fill Color #Color#|Rotate -50\"]"
	...
	meterOptions = meterOptions .. "[!SetOption Shape Shape"..(countshape+5).." \"Rectangle (28*#scale#),(170*#scale#),(300*#scale#),(-2*#scale#) | StrokeWidth 0 | Fill Color #Color#|Rotate -50\"]"
