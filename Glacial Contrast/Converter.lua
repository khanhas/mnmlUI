...
function ConvertFile()
	...
	meterOptions = meterOptions .. "[!SetOption Shape Shape"..(countshape+1).." \"Rectangle 0,0,0,0\"][!SetOption Shape Shape"..(countshape+2).." \"Combine Shape"..(countshape+1)..table.concat(union).."\"][!SetOption Shape Shape"..(countshape+3).." \"Rectangle 0,(160*#scale#),(220*#scale#),(120*#scale#) | StrokeWidth 0 | Fill Color #Color#\"][!SetOption Shape Shape"..(countshape+4).." \"Combine Shape"..(countshape+3).."|XOR Shape"..(countshape+2).."\"]"
