...
function LeftMouseUpCallback(mouseX, mouseY)
	...
	local windowWidth = tonumber(SKIN:GetVariable("WindowW"))
	local windowHeight = tonumber(SKIN:GetVariable("WindowH"))
	bang = bang .. "[!WriteKeyValue Variables WindowPosX " .. skinPosX .. "]" 							   			-- Write X pos in case of refresh
	bang = bang .. "[!WriteKeyValue Variables WindowPosY " .. skinPosY .. "]" 							   			-- Write Y pos in case of refresh
	bang = bang .. "[!WriteKeyValue Variables WindowW " .. windowWidth .. "]" 					   			-- Write Width in case of refresh
	bang = bang .. "[!WriteKeyValue Variables WindowH " .. windowHeight .. "]" 					   			-- Write Height in case of refresh
	bang = bang .. "[!UpdateMeter *][!Redraw]"
